      ...
      <Container>
        ...
        <Box className={classes.searchBox}>
          <TextField
            ...
            InputProps={{
              style: { color: "white", border: "1px solid  #00e7ff", marginBottom: "0.3rem" },
              startAdornment: (
                <InputAdornment position="start">
                  <SearchIcon style={{ color: "#bb8c00", fontSize: "2.1rem" }} />
                </InputAdornment>
              ),
            }}
            InputLabelProps={{
          ...
          <Button className={classes.priceButton}>
            <Link to={`/stats`} className={classes.white}>
              Global Statistic
            </Link>
          </Button>
        </Box>
